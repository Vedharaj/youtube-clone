...
import { clearVideos, changeSearchTerm, clearSearchTerm, getSearchPageVideo  } from '../store/reducers/youtubeApp';
...
const Navbar = () => {
    ...
    const { searchTerm } = useSelector((store)=>store.youtubeApp)
    const handleSearch = ()=>{
  ...
  return (
    <div className="flex justify-between items-center px-14 h-14 bg-zinc-900 opacity-95 sticky top-0 z-50">
        <div className="flex gap-8 items-center text-2xl">
            ...
            <Link to='/'>
                {/* <div className="flex gap-1 items-center justify-center">
                    ...
                    <span className='text-xl font-medium mb-1'>YouTube</span>
                </div> */}
                <div className='w-24 h-14 text-white'>
                <svg xmlns="http://www.w3.org/2000/svg" id="yt-logo-updated-svg_yt12" className="external-icon" viewBox="0 0 90 20" focusable="false" style={{pointerEvents: "none", display: "inherit", width: "100%", height: "100%"}}>
        ...
        <div className="flex justify-center items-center gap-5">
            <form onSubmit={(e)=>{
                ...
                <div className="flex bg-zinc-900 items-center h-10 px-4 pr-0 rounded-full border-l border-t border-b border-zinc-800">
        ...
        <div>
            <div className="flex items-center gap-5 text-xl">
                    ...
                    <div className="relative">
                        <BsBell />
                        <span className="absolute bottom-2 left-2 bg-red-600 rounded-full px-1 text-sm">
                            9+
                        </span>
                    </div>
                    <img 
                        className='w-9 h-9 rounded-full'
                        src="https://yt3.ggpht.com/yti/ANjgQV9o_7BRxakrRUbm-tyxLtIuI9w8D0gumA4CoJ4Nbguen54=s88-c-k-c0x00ffffff-no-rj" 
                        alt="logo" 
                    />
                </div>
            </div>
